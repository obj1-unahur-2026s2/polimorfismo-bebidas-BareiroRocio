...
* **Cianuro**: el cianuro no favorece al rendimiento, sino que el deportista, luego de consumirlo queda como muerto, llenos de abulia y de marasmo. Con cianuro, el rendimiento sera 0 si el peso del deportista 70 o menos. Si es mas que 70 entonces el rendimiento que aporta es el 1 del peso mas la dosis consumida.
...
Agregar a Pepe otro voluntario que inicialmente pesa 80,tiene 30 años. pepe debe poder cumplir años y se diferencia de tito en que para calcular su velocidad si tien mas de 30 entonces le resta 10 de velocidad.
